...
To compute the models, I used the Robyn library. Starting from the script Data_campaigns.R, I processed the dataset containing the company’s advertising expenditures across different platforms and advertisement types.
